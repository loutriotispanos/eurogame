 ...
 */
var CACHE = "elg-v50";  /* Active careers batch 8: +23 researched paths (Dubai BC + Zalgiris + Virtus Bologna, all now complete); careers 377->400; regenerated paths/grids/puzzles */
var ASSETS = [
