 ...
 */
var CACHE = "elg-v48";  /* Active careers batch 6: +22 researched paths (AS Monaco + Baskonia + FC Barcelona, all now complete); careers 334->356; regenerated paths/grids/puzzles */
var ASSETS = [
