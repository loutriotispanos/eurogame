 ...
 * `node build_paths.js --eurocup` writes eurocup_paths.js (window.EUROCUP_PATHS)
...
// `node build_paths.js --eurocup` builds the EuroCup bank (eurocup_paths.js)
// instead: competition.js runs with the EuroCup chosen, so the generator walks
// the same teammate graph the game does.
...
const FILE = EC ? "eurocup_paths.js" : "paths.js";
const out = "/* AUTO-GENERATED by build_paths.js" + (EC ? " --eurocup" : "") + " — do not edit by hand. Puzzles for Path Between" + (EC ? " (EuroCup)" : "") + ". */\n" +
  "window." + (EC ? "EUROCUP_PATHS" : "PATHS") + " = [\n" +
